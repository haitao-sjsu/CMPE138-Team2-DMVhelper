...
if (isset($_POST['update'])) {
    ...
    echo '<input type="text" id="stem" name="stem" value="'.$stem.'" style="font-size: 25px; width: 1000px; height: 100px;">';
    echo '<br><br>';
    echo '<label for="num_of_options">'.$UI['admin_crud_question']['num_of_options'][$lang].'</label>';
    echo '<input type="text" id="num_of_options" name="num_of_options" value="'.$num_of_options.'" style="font-size: 25px;">';
    echo '<br><br>';
    echo '<label for="option1">'.$UI['admin_crud_question']['option'][$lang].'1</label>';
    echo '<input type="text" id="option1" name="option1" value="'.$option1.'" style="font-size: 25px; width: 800px; height: 30px;">';
    echo '<br><br>';
    echo '<label for="option2">'.$UI['admin_crud_question']['option'][$lang].'2</label>';
    echo '<input type="text" id="option2" name="option2" value="'.$option2.'" style="font-size: 25px; width: 800px; height: 30px;">';
    echo '<br><br>';
    echo '<label for="option3">'.$UI['admin_crud_question']['option'][$lang].'3</label>';
    echo '<input type="text" id="option3" name="option3" value="'.$option3.'" style="font-size: 25px; width: 800px; height: 30px;">';
    echo '<br><br>';
    echo '<label for="option4">'.$UI['admin_crud_question']['option'][$lang].'4</label>';
    echo '<input type="text" id="option4" name="option4" value="'.$option4.'" style="font-size: 25px; width: 800px; height: 30px;">';
    echo '<br><br>';
    echo '<label for="answer">'.$UI['admin_crud_question']['answer'][$lang].'</label>';
    echo '<input type="text" id="answer" name="answer" value="'.$answer.'" style="font-size: 25px;">';
    echo '<br><br>';
    echo '<label for="page_id">'.$UI['admin_crud_question']['page_id'][$lang].'</label>';
    echo '<input type="text" id="page_id" name="page_id" value="'.$page_id.'" style="font-size: 25px;">';
    echo '<br><br>';
